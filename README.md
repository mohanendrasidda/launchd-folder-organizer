...
- **Version-sibling clustering** — when two or more entries normalize to the same base name (e.g. `paper-1.pdf`, `paper-2.pdf`, `paper (3).pdf`), they are bundled into `<category>/<base>-versions/`. Pre-existing `-versions` folders also attract new siblings.
